...
hdfs dfs -rm -r /user/root/code_category
sqoop import \
--connect jdbc:mysql://192.168.10.31:3306/szbap_ods \
--username root \
--password 123456 \
--table code_category \
...
hdfs dfs -rm -r /user/root/code_city
sqoop import \
--connect jdbc:mysql://192.168.10.31:3306/szbap_ods \
--username root \
--password 123456 \
...
########################### code_education ################################
hdfs dfs -rm -r /user/root/code_education
sqoop import \
--connect jdbc:mysql://192.168.10.31:3306/szbap_ods \
--username root \
--password 123456 \
...
########################### code_email_suffix ################################
hdfs dfs -rm -r /user/root/code_email_suffix
sqoop import \
--connect jdbc:mysql://192.168.10.31:3306/szbap_ods \
--username root \
--password 123456 \
...
########################### code_goods ################################
hdfs dfs -rm -r /user/root/code_goods
sqoop import \
--connect jdbc:mysql://192.168.10.31:3306/szbap_ods \
--username root \
--password 123456 \
...
########################### code_profession ################################
hdfs dfs -rm -r /user/root/code_profession
sqoop import \
--connect jdbc:mysql://192.168.10.31:3306/szbap_ods \
--username root \
--password 123456 \
...
########################### code_shop ################################
hdfs dfs -rm -r /user/root/code_shop
sqoop import \
--connect jdbc:mysql://192.168.10.31:3306/szbap_ods \
--username root \
--password 123456 \
